...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot VGA_project xil_defaultlib.VGA_project xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim VGA_project -key {Behavioral:sim_1:Functional:VGA_project} -tclbatch cmd.tcl -log simulate.log
}
